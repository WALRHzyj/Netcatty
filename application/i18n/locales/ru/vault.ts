...
export const ruVaultMessages: Messages = {
  ...
  'aiPromptPresets.title': 'AI подсказки',
  'aiPromptPresets.desc': 'Редактируемые версии подсказок, отправляемых AI. Оставьте плейсхолдеры ${...} без изменений — они подставляются во время выполнения.',
  'aiPromptPresets.section.system.title': 'Системные подсказки',
  'aiPromptPresets.section.system.desc': 'Подсказки, управляющие поведением встроенного агента (роль, правила инструментов, безопасность сессий).',
  'aiPromptPresets.section.user.title': 'Подсказки из заметок пользователя',
  'aiPromptPresets.section.user.desc': 'Подсказки, расширяющие поведение агента через заметки хранилища. Скоро.',
  'aiPromptPrompts.section.user.placeholder': 'Подсказки из заметок пользователя пока недоступны; раздел зарезервирован для будущего выпуска.',
  'aiPromptPresets.section.user.placeholder': 'Подсказки из заметок пользователя пока недоступны; раздел зарезервирован для будущего выпуска.',
  'aiPromptPresets.resetAll': 'Сбросить все',
  'aiPromptPresets.card.catty:system.name': 'Системная подсказка Catty Agent',
  'aiPromptPresets.card.catty:system.desc': 'Основная роль, инструкции по инструментам и права на уровне сессии для агента Catty.',
  'aiPromptPresets.card.catty:compaction.name': 'Подсказка сжатия контекста',
  'aiPromptPresets.card.catty:compaction.desc': 'Подсказка для суммаризации ранних реплик, когда разговор превышает размер контекстного окна.',
  'aiPromptPresets.card.catty:review.name': 'Подсказка проверки безопасности команд',
  'aiPromptPresets.card.catty:review.desc': 'Подсказка для классификации команд как безопасных / осторожных / опасных в режиме проверки.',
  'aiPromptPresets.edit': 'Изменить',
  'aiPromptPresets.save': 'Сохранить',
  'aiPromptPresets.cancel': 'Отмена',
  'aiPromptPresets.reset': 'Восстановить по умолчанию',
  'aiPromptPresets.badge.custom': 'Своя',
  'aiPromptPresets.badge.default': 'По умолчанию',
  'aiPromptPresets.charCount': '{n} симв.',
  'aiPromptPresets.warn.tokens': 'Не удаляйте плейсхолдеры ${...} — они подставляются во время выполнения.',
  'aiPromptPresets.save.success': 'Сохранено',
  'aiPromptPresets.reset.success': 'Восстановлено значение по умолчанию',
