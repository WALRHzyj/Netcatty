...
export const ruVaultMessages: Messages = {
  ...
  'aiPromptPresets.section.user.title': 'Заметки хостов',
  'aiPromptPresets.section.user.desc': 'Единое место для редактирования заметок всех хостов. Изменения синхронизируются с панелью каждого хоста.',
  // VaultHostNotesManager
  'hostNotesManager.empty.title': 'Пока нет хостов',
  'hostNotesManager.empty.desc': 'Создайте хост в разделе «Хосты», чтобы добавить к нему заметку.',
  ...
  'hostNotesManager.dirty': 'Изменено',
