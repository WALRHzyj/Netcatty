...
export const zhCNAiMessages: Messages = {
  ...
  'ai.safety.permissionMode.review': '审查 - AI审查 + 分级放行',
  'ai.safety.permissionMode.reviewDesc': '黑名单直接拒绝，白名单直接通过，其余交由旁路 AI 判定风险等级：安全→自动执行，需确认→弹窗审批，危险→自动拒绝',
