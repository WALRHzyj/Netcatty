...
export const zhCNVaultMessages: Messages = {
  ...
  'logs.filter.datePreset': '时间范围',
  'logs.filter.datePreset.today': '今天',
  'logs.filter.datePreset.7d': '最近 7 天',
  'logs.filter.datePreset.30d': '最近 30 天',
  'logs.filter.datePreset.all': '全部时间',
  'logs.filter.datePreset.custom': '自定义',
  'logs.filter.dateFrom': '从',
  'logs.filter.dateTo': '到',
  'logs.filter.host': '按主机',
  'logs.filter.hostPlaceholder': '全部主机',
  'logs.filter.user': '按用户',
  'logs.filter.userPlaceholder': '搜索用户名…',
  'logs.filter.clear': '清除筛选',
  'logs.filter.resultsCount': '共 {count} 条',
  'logs.empty.filtered.title': '没有符合条件的日志',
  'logs.empty.filtered.desc': '请调整筛选条件后重试。',
  'logs.pagination.pageSize': '每页显示',
  'logs.pagination.pageSize.s20': '20 条',
  'logs.pagination.pageSize.s50': '50 条',
  'logs.pagination.pageSize.s100': '100 条',
  'logs.pagination.summary': '第 {from}-{to} 条，共 {total} 条',
  'logs.pagination.first': '首页',
  'logs.pagination.prev': '上一页',
  'logs.pagination.next': '下一页',
  'logs.pagination.last': '末页',
  'logs.pagination.pageIndicator': '第 {current}/{total} 页',

  // AI prompt presets (Vault → AI Prompts)
  'aiPromptPresets.title': 'AI 提示词',
  'aiPromptPresets.desc': '修改发送给 AI 的提示词。${...} 占位符会在运行时被实际内容替换，请勿删除。',
  'aiPromptPresets.section.system.title': '系统级提示词',
  'aiPromptPresets.section.system.desc': '驱动内置 Agent 行为的提示词（角色、工具规则、会话安全）。',
  'aiPromptPresets.section.user.title': '主机备注',
  'aiPromptPresets.section.user.desc': '在此集中编辑所有主机的备注内容，修改会同步回每台主机的详情页。',
  // VaultHostNotesManager
  'hostNotesManager.empty.title': '暂无主机',
  'hostNotesManager.empty.desc': "先在「主机」页创建主机，即可在此处添加备注。",
  ...
  'hostNotesManager.dirty': '已修改',
  'aiPromptPresets.resetAll': '全部重置',
  'aiPromptPresets.card.catty:system.name': 'Catty Agent 主体提示词',
  'aiPromptPresets.card.catty:system.desc': 'Catty 侧 AI 的用户身份、工具使用说明与按会话的权限规则。',
  'aiPromptPresets.card.catty:compaction.name': '上下文压缩提示词',
  'aiPromptPresets.card.catty:compaction.desc': '对话超出上下文窗口时，用于对早期轮次进行摘要压缩。',
  'aiPromptPresets.card.catty:review.name': '命令安全审查提示词',
  'aiPromptPresets.card.catty:review.desc': 'review 模式下用于把 shell 命令分类为安全 / 警告 / 危险的提示词。',
  'aiPromptPresets.edit': '编辑',
  'aiPromptPresets.save': '保存',
  'aiPromptPresets.cancel': '取消',
  'aiPromptPresets.reset': '恢复默认',
  'aiPromptPresets.badge.custom': '自定义',
  'aiPromptPresets.badge.default': '默认',
  'aiPromptPresets.charCount': '{n} 字符',
  'aiPromptPresets.warn.tokens': '请勿删除 ${...} 占位符 — 它们在运行时被替换为实际内容。',
  'aiPromptPresets.save.success': '已保存',
  'aiPromptPresets.reset.success': '已恢复默认',
