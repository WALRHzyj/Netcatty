...
export const zhCNVaultMessages: Messages = {
  ...
  'aiPromptPresets.section.user.title': '用户备注提示词',
  'aiPromptPresets.section.user.desc': '通过保险箱笔记扩展 Agent 行为的提示词，即将推出。',
  'aiPromptPresets.section.user.placeholder': '用户备注提示词尚未开放，该区域为后续版本预留。',
