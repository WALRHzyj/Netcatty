...
export const enAiMessages: Messages = {
  ...
  'ai.safety.permissionMode.review': 'Review - AI audit + tiered execution',
  'ai.safety.permissionMode.reviewDesc': 'Blacklist → deny. Whitelist → allow. Unknown → AI risk assessment: safe auto-pass, caution confirm, dangerous auto-deny.',
