...
export const enVaultMessages: Messages = {
  ...
  // Connection logs — filters & pagination
  'logs.filter.title': 'Filters',
  'logs.filter.datePreset': 'Date range',
  'logs.filter.datePreset.today': 'Today',
  'logs.filter.datePreset.7d': 'Last 7 days',
  'logs.filter.datePreset.30d': 'Last 30 days',
  'logs.filter.datePreset.all': 'All time',
  'logs.filter.datePreset.custom': 'Custom',
  'logs.filter.dateFrom': 'From',
  'logs.filter.dateTo': 'To',
  'logs.filter.host': 'Host',
  'logs.filter.hostPlaceholder': 'All hosts',
  'logs.filter.user': 'User',
  'logs.filter.userPlaceholder': 'Search username…',
  'logs.filter.clear': 'Clear filters',
  'logs.filter.resultsCount': '{count} results',
  'logs.empty.filtered.title': 'No matching logs',
  'logs.empty.filtered.desc': 'Try adjusting your filters.',
  'logs.pagination.pageSize': 'Per page',
  'logs.pagination.pageSize.s20': '20',
  'logs.pagination.pageSize.s50': '50',
  'logs.pagination.pageSize.s100': '100',
  'logs.pagination.summary': '{from}–{to} of {total}',
  'logs.pagination.first': 'First',
  'logs.pagination.prev': 'Previous',
  'logs.pagination.next': 'Next',
  'logs.pagination.last': 'Last',
  'logs.pagination.pageIndicator': 'Page {current} / {total}',

  // AI prompt presets (Vault → AI Prompts)
  'aiPromptPresets.title': 'AI Prompts',
  'aiPromptPresets.desc': 'Editable versions of the prompts sent to the AI. Leave ${...} placeholders intact — they are replaced at runtime with live context.',
  'aiPromptPresets.section.system.title': 'System-level Prompts',
  'aiPromptPresets.section.system.desc': 'Prompts that drive built-in agent behaviour (role, tool rules, session safety).',
  'aiPromptPresets.section.user.title': 'Host Notes',
  'aiPromptPresets.section.user.desc': 'Per-host notes editable in one place. Changes here sync back to each host\'s detail panel.',
  // VaultHostNotesManager
  'hostNotesManager.empty.title': 'No hosts yet',
  'hostNotesManager.empty.desc': 'Create a host in Vault → Hosts to add host-specific notes here.',
  ...
  'hostNotesManager.dirty': 'Modified',
  'aiPromptPresets.resetAll': 'Reset all',
  'aiPromptPresets.card.catty:system.name': 'Catty Agent System Prompt',
  'aiPromptPresets.card.catty:system.desc': 'Main role, tool-usage instructions, and session-level permission rules for the Catty agent.',
  'aiPromptPresets.card.catty:compaction.name': 'Context Compaction Prompt',
  'aiPromptPresets.card.catty:compaction.desc': 'Prompt used to summarise earlier turns when the conversation exceeds the context window.',
  'aiPromptPresets.card.catty:review.name': 'Command Safety Review Prompt',
  'aiPromptPresets.card.catty:review.desc': 'Prompt used in review mode to classify shell commands as safe / caution / dangerous.',
  'aiPromptPresets.edit': 'Edit',
  'aiPromptPresets.save': 'Save',
  'aiPromptPresets.cancel': 'Cancel',
  'aiPromptPresets.reset': 'Reset to default',
  'aiPromptPresets.badge.custom': 'Custom',
  'aiPromptPresets.badge.default': 'Default',
  'aiPromptPresets.charCount': '{n} chars',
  'aiPromptPresets.warn.tokens': 'Do not delete ${...} placeholders — they are replaced at runtime.',
  'aiPromptPresets.save.success': 'Saved',
  'aiPromptPresets.reset.success': 'Reset to default',
