...
export const enVaultMessages: Messages = {
  ...
  'aiPromptPresets.section.user.title': 'User-note Prompts',
  'aiPromptPresets.section.user.desc': 'Prompts that extend agent behaviour via Vault notes. Coming soon.',
  'aiPromptPresets.section.user.placeholder': 'User-note prompts are not yet available. This section is reserved for a future release.',
